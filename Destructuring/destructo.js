...
console.log(`Coordinates are x: ${x} and y: ${y}`);
...
console.log(`Key locations are: ${first} and ${second}`);
...
console.log(`The door code sequence is: ${upper}, ${middle}, ${lower}`);
...
console.log(`The extracted stones are ${firstStone} and ${sixthStone}.`);
...
console.log(`The visible shadow is ${visibleShadow}, and the rest are the ${hiddenShadows[0]}, the ${hiddenShadows[1]}, and the ${hiddenShadows[2]}.`);
...
function revealPath ({direction, distance}) {
   console.log(`Go ${distance} to the ${direction}.`);
};
 
revealPath({direction: "east", distance: "10 miles"});
...
function mixPotion ({ingredient1 = "Water", ingredient2 = "Fireflower"}){
	console.log(`Ingredient 1 is ${ingredient1} and ingredient 2 is ${ingredient2}.`);
}
...
function castSpell([firstIngredient, secondIngredient]){
    console.log(`First ingredient is ${firstIngredient}. Second ingredient is ${secondIngredient}.`); 
}

castSpell(["scullcap", "nettle", "toenails", "moss"]);
...
console.log(`The stoneA was Emerald but is now ${stoneA} and stoneB was Ruby but is now ${stoneB}.`);